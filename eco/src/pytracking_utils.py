...
#def _read_image_old(image_file: str):
#        im = cv2.imread(image_file)
#        return cv2.cvtColor(im, cv2.COLOR_BGR2RGB)


def _read_image(image_file: str,preprocessing_step):
        if preprocessing_step=='quantization':
...
def initial_preprocess(image, info: dict) -> dict:
