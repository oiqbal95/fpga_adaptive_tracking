...
def load_pretrained(module, name, checkpoint='atom_default.pth', **kwargs):
    ...
    print(os.path.join(settings.env.workspace_dir, 'checkpoints', 'ltr', module, name))
    return load_network(network_dir=network_dir, checkpoint=checkpoint, **kwargs)


def load_network(network_dir='/home/ame/Adaptive_Subsampling/pytracking/checkpoints/checkpoints/ltr/bbreg/atom_paper', checkpoint='dimp50.pth', constructor_fun_name=None, constructor_module=None, **kwargs):
