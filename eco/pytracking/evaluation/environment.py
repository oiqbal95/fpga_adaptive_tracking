...
class EnvSettings:
    def __init__(self):
        ...
        #self.network_path = 'dataset/resnet18_vggmconv1.pth'
        ...
        self.vot_path = ''
        self.got10k_path = ''
        self.lasot_path = '/home/ame/Adaptive_Subsampling/LaSOT/Main_Dataset'
        self.trackingnet_path = '/home/ame/Adaptive_Subsampling/TrackingNet'
        self.davis_dir = ''
        self.youtubevos_dir = ''

        self.got_packed_re5sults_path = ''
