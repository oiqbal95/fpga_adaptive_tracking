...
################## Custom Functions ###################
def yolo_preprocessing(image):
    """ Turns image from 640x480 to 416x416 with padding """
    new_image = cv2.resize(image, (416, 312), interpolation=cv2.INTER_LINEAR)
    h_padding = 52
    boxed_image = cv2.copyMakeBorder(new_image, h_padding, h_padding, 0, 0, cv2.BORDER_CONSTANT, value=(128,128,128)) 
